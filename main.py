    ...
    def __init__(self):
        ...
        self.responses = {
            ...
            "부산에서 가볼만한 자연/공원에 대해 추천해줘": [
                ...
                "송도 해수욕장을 추천합니다. 부근에는 송도 센트럴파크와 다양한 관광 명소가 있어, 해변에서 레저를 즐긴 후에 관광할 곳이 많습니다.",
            ...
            "부산에서 가볼만한 카페/디저트에 대해 추천해줘": [
                ...
                "초량1941 초량점을 추천합니다. 올라가는길이 힘드니 차량을 통해 이동하지 않는것을 추천하지만 건물의 외관이 굉장히 아름다운 곳입니다.",
                ...
                "코랄라니 부산기장점을 추천합니다. 대형 베이커리이고 경관이 굉장히 좋기에 많은 사람을 수용하면서 바다에 위치하여 야외석에서 바다를 보면서 먹기 좋은 카페입니다.",
                "오션브리즈 청사포을 추천합니다. 카페가 굉장히 넓어 많은 사람들이 갈 수 있고 바다를 보면서 먹기 좋은 카페입니다.",
                "Cafe de 200VOLT 영도점을 추천합니다. 카페의 위쪽에서는 영도에서 부산바다와 시내를 내려다 볼 수 있는 매력적인 경관을 가지고 있습니다.",
                "Cafe de 200VOLT 영도점을 추천합니다. 부산에서 힐링하면서 옥상 루프탑에서 바람을 쐴 수 있을 정도로 멋진 분위기를 가진 카페입니다."
            ],
